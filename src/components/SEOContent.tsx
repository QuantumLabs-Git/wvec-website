        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <div>
              ...
              <Link 
                href="/contact"
                className="inline-flex items-center text-champagne hover:text-champagne smooth-transition font-medium"
              >
                Get Directions →
              </Link>
            </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                ...
                className="bg-champagne text-black px-6 py-3 rounded-full hover:bg-champagne/80 smooth-transition"
              >
                What We Believe
              </Link>
              <Link
                href="/service-times"
                className="bg-black text-white border-2 border-champagne px-6 py-3 rounded-full hover:bg-champagne hover:text-black smooth-transition"
              >
                Service Times
              </Link>
            </div>
