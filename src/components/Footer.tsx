        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="space-y-4 text-center sm:text-left">
            <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-3 sm:space-y-0 sm:space-x-3">
              ...
              />
              <h3 className="font-serif text-lg sm:text-xl text-white text-center sm:text-left">
                Whiddon Valley Evangelical Church
              </h3>
            </div>
            <p className="text-white/70 text-sm italic max-w-sm mx-auto sm:mx-0">
          ...
          <div className="space-y-4 text-center sm:text-left">
            ...
            <address className="not-italic text-white/70 text-sm sm:text-base space-y-1">
            ...
            <a
              ...
              className="inline-flex items-center justify-center sm:justify-start space-x-2 text-champagne hover:text-champagne/80 smooth-transition"
            >
          ...
          <div className="space-y-4 text-center sm:text-left sm:col-span-2 lg:col-span-1">
            ...
            <div className="space-y-2">
              <a
                ...
                className="flex items-center justify-center sm:justify-start space-x-2 text-white/70 hover:text-champagne smooth-transition"
              >
            ...
            <div className="flex justify-center sm:justify-start space-x-4 pt-4">
              <a
                ...
                className="text-white/70 hover:text-champagne smooth-transition p-2"
                aria-label="YouTube"
              >
